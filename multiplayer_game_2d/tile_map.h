...
struct tile_map
{
  ...
  tile_map(const char* tiles_texture_file_path, const float window_size_x, const float window_size_y, const int p_tile_side_length) : tile_size_x(window_size_x / rows),tile_size_y(window_size_y / columns), tile_sheet_side_length(p_tile_side_length)
  {
